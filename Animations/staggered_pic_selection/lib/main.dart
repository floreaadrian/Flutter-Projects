...
final List<Photo> allPhotos = List<Photo>.generate(9, (int index) {
...
class PhotoItem extends StatefulWidget {
  PhotoItem({Key key, this.photo, this.color, this.onTap, this.selected})
      : super(key: key);
...
void main() => runApp(MaterialApp(home: ImagesDemo()));
